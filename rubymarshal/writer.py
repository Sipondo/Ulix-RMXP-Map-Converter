...
import math
import re
from . import rmxptypes  # Adds support for RPG Maker XP types
...
class Writer:
    ...
    def write(self, obj):
        ...
        elif isinstance(obj, rmxptypes.Table):
            self.write_table(obj)
        else:
            self.write_python_object(obj)

    def write_table(self, obj):
        self.fd.write(TYPE_USERDEF)
        self.write(Symbol("Table"))
        self.write_long(obj.dlen)
        self.fd.write(obj.tobytes())
